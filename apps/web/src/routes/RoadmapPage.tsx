...
const phases: Phase[] = [
  {
    ...
    items: [
      { text: 'Deterministic eval pass — eval selalu mulai dari anchor index yang tetap, bukan random', done: false },
      { text: 'Eval env terpisah dari train env — chronological split diterapkan sampai ke evaluation loop', done: false },
      { text: 'Richer executed-trade ledger — catat entry price, exit price, realized PnL, hold duration per trade', done: false },
      { text: 'Replay/history konsisten antara env, trainer, backend, dan frontend', done: false },
    ],
