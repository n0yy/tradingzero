...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      { text: 'Audit reward design — pastikan rolling Sharpe tidak inflate dari episode pendek atau data homogen', done: true },
      { text: 'Overtrading fix — action penalty + cooldown supaya Txns per episode berada di range 4–20', done: true },
      { text: 'Action constraints — action masking yang benar untuk MultiDiscrete([3, 4])', done: true },
      { text: 'Hyperparameter sweep — n_steps, ent_coef, clip_range, episode_length via W&B', done: false },
      { text: 'Baseline benchmark — agent harus konsisten mengalahkan random agent dan buy-and-hold', done: true },
    ],
